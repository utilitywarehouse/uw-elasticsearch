...
RUN wget http://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.2.4.tar.gz
RUN tar -zxvf elasticsearch-6.2.4.tar.gz --strip 1
...
RUN ./elasticsearch-plugin install https://distfiles.compuscene.net/elasticsearch/elasticsearch-prometheus-exporter-6.2.4.0.zip
